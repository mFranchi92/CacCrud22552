...
public class AppServlet extends HttpServlet {
    ...
    private static final String URI_DETAILS = "WEB-INF/pages/alumnos/detallesAlumno.jsp";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (laAccion) {
            ...
            case "details":
                ...
                req.setAttribute("alumnoAMostrar", alum);
                req.getRequestDispatcher(URI_DETAILS).forward(req, resp);
                break;
            default:
